...
const HabitForm = props => {
  ...
  const handleSubmit = async (event) => {
    ...
    await rolesService.addHabit({name: enteredName, amount: enteredAmount}, props.role._id);
    props.handleAddHabit();
  };

  const handleUpdateSubmit = async (event) => {
    event.preventDefault();
    await rolesService.updateHabit({name: enteredName, amount: enteredAmount}, props.habit._id);
